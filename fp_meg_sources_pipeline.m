...
inDir = 'C:\Users\simon\Downloads\fp2';
ProtocolName = 'fp2';
%inDir = char(strcat(inDir, filesep, ProtocolName));
outDir = char(strcat(inDir, filesep, ProtocolName, filesep, 'results'));
epTime = 2;
...
for i = 1:N
    ...
    newSourceFiles = sources_projection(sourceFiles, srcSubject, ...
        inDir, ProtocolName, epMax, outDir, condition, srcType);
    scout_extraction_reprojected(newSourceFiles, scout, ROIs, ...
        srcSubject, epTime, epMax, inDir, ProtocolName, outDir);
end
disp(1)   
